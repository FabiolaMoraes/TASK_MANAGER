...
uses Winapi.Windows, Winapi.Messages, System.SysUtils, System.Variants, System.Classes, Vcl.Graphics,
  Vcl.Controls, Vcl.Forms, Vcl.Dialogs, Views.Base, Vcl.WinXPanels,
...
procedure TFrmBaseCadastro.DBGridKeyDown(Sender: TObject; var Key: Word; Shift: TShiftState);
begin
  inherited;
  case key of
    VK_Insert:
...
begin
  ...
  CalcularPaginacao;
  lblPagina.Caption := Format('Páginas %d de %d', [FService.Page, FService.Pages]);
end;
